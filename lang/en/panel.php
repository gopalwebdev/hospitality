...
return [
    ...
    'items' => [
        ...
        'original_price_invalid' => 'The original price has to be higher than the price you charge.',
    ...
    'orders' => [
        ...
        // The guest's intent to pay now or add it to the bill, and what has
        // actually been taken against the order — App\Enums\OrderSettlement
        // and App\Enums\PaymentState between them.
        'settlement' => 'Settlement',
        'payment' => 'Payment',
        'outstanding' => 'Outstanding',
        'unsettled_only' => 'Unsettled only',
        'payments_section' => 'Payments',
        'no_payments' => 'Nothing has been paid on this order yet.',
        // Record payment: an order still owing money, settled on the spot —
        // and the same fields Settle asks for a location's whole running bill.
    ...
    'take_order' => [
        ...
        'back' => 'Back',
        // Changing an order nobody has picked up yet: the counter again, with
        // that order already in its basket. See App\Actions\Orders\ReviseOrder.
        'change_title' => 'Change order #:number',
        'changing' => 'Changing order #:number',
        'changing_hint' => 'Nobody has picked this one up yet, so it can still be changed. Saving replaces what is on it and adjusts stock to match.',
        'save' => 'Save changes · :amount',
        'save_short' => 'Save',
        'changed' => 'Order #:number changed',
        'cannot_change' => 'This order can no longer be changed',
        'lines_dropped' => '{1} 1 line could not be loaded — what it was ordering is gone.|[2,*] :count lines could not be loaded — what they were ordering is gone.',
    ...
    'add_on_groups' => [
        ...
        // added to. A code here is for an option that is a separate supply.
        'tax_code' => 'GST / HSN',
        'tax_rate_placeholder' => "Item's",
        'option' => 'Option',
        'price' => 'Price',
        'free' => 'Free',
        'max_per_item' => 'Max each',
        'is_default' => 'Default',
        ...
        'max_per_item_above_max' => 'This cannot be more than the maximum.',
        'item_max_picks' => 'Maximum on this item',
        'item_max_picks_below_defaults' => 'This cannot be less than how many options are set as the default.',
    ...
    'locations' => [
        ...
        'range_from' => 'From',
        'range_to' => 'To',
        'range_created' => '{0} They already exist — nothing new added.|{1} 1 location added.|[2,*] :count locations added.',
        'unique' => 'This tenant already has a location with that name.',
        'delete_warning' => 'Past orders keep the name this location had when they were placed. Switch it off instead if you might use it again.',
        'empty_heading' => 'No locations yet',
        'empty_description' => 'A guest\'s order names one of these — "Room 204", "Table 5", "Poolside". Add the first one, or add several at once.',
        'settle_heading' => 'Settle :name',
    ],

    'payment_devices' => [
        'label' => 'payment device',
        'plural' => 'Payment devices',
        'create' => 'New payment device',
        'section' => 'Payment device',
        'kind' => 'Kind',
        'identifier' => 'Identifier',
        'is_active' => 'Available',
        'delete_warning' => 'Past payments keep their own record of this device. Switch it off instead if you might use it again.',
        'empty_heading' => 'No payment devices yet',
        'empty_description' => 'Add the card machines and QR codes a payment can be recorded against, for reconciliation.',
    ],
    ...
    'payments' => [
        ...
        'view' => 'Open',
        'void' => 'Void',
        'void_heading' => 'Void payment #:number?',
        'void_warning' => 'Every order it settled goes back to what it still owes. This cannot be undone.',
        'voided_notification' => 'Payment voided',
        'empty_heading' => 'No payments yet',
        'empty_description' => 'Payments recorded against an order, from its own page or from Settle, arrive here.',
    ],
