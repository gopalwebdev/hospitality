...
return [
    ...
    'items' => [
        ...
        'on_offer' => 'On offer',
        'min_quantity' => 'Minimum per order',
        'max_quantity' => 'Maximum per order',
        'no_limit' => 'No limit',
        'max_quantity_below_min' => 'The maximum cannot be fewer than the minimum.',
        'tax_section' => 'Tax',
        'tax_rate' => 'GST rate',
    ...
    'add_on_groups' => [
        ...
        'requirement' => 'Is it required?',
        'selection' => 'How many can a guest pick?',
        'only_one' => 'Only one',
        'more_than_one' => 'More than one',
        'min_selections' => 'Minimum',
        'max_selections' => 'Maximum',
        'allows_quantities' => 'Same option more than once',
        'no_limit' => 'No limit',
        'rule' => 'Guest picks',
        'required' => 'Required',
        'optional' => 'Optional',
        ...
        'max_below_min' => 'The maximum cannot be fewer than the minimum.',
        'max_below_two' => 'More than one needs a maximum of at least 2, or no limit.',
        'min_above_options' => 'The options cannot add up to that many picks.',
