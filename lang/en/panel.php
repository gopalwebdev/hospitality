...
return [
    ...
    'add_on_groups' => [
        ...
        'tax_rate' => 'GST',
        'is_preselected' => 'Default',
        'is_available' => 'Available',
        'add_option' => 'Add an option',
        'is_required' => 'Guest must choose',
        'min_selections' => 'Min choices',
        'max_selections' => 'Max choices',
        'no_limit' => 'No limit',
        'rule' => 'Guest picks',
        'required' => 'Required',
        'optional' => 'Optional',
        ...
        'max_below_min' => 'Max choices cannot be fewer than min choices.',
        'min_above_options' => 'The options cannot add up to that many picks.',
        'preselected_above_max' => 'More options are set as the default than a guest may pick.',
        'max_quantity_above_max' => 'This cannot be more than Max choices allows.',
